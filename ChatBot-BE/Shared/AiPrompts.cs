...
3. **Delete** an existing policy record by policy number
...
- **IMPORTANT**: When you have gathered enough information to perform an action, use the designated function tools (`create_user`, `view_user`, `delete_user`).
